...
//string connectionString = "Server=localhost;Database=employee_db;Uid=root;Pwd=1hsan@SQL";

string mySqlConnectionString = "server=localhost; user=root; database=employee_db; password =  1hsan@SQL";
